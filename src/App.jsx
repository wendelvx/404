          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left mt-20 lg:mt-0 z-10">
            ...
            <div className="mt-2 w-full flex justify-center lg:justify-start" translate="no">
              <DecryptedText
                ...
                className="text-cyan-400 font-mono text-base md:text-xl tracking-[0.45em] font-bold"
                encryptedClassName="text-zinc-500 font-mono text-base md:text-xl tracking-[0.45em]"
              />
            </div>
          </div>
                ...
                <Card key={item.id}>
                  <div className="w-full h-full bg-zinc-900 border border-white/10 rounded-[2.5rem] p-8 md:p-12 flex flex-col justify-center items-center text-center shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="z-10 flex flex-col items-center gap-6">
                      ...
                      <h4 className="text-3xl md:text-4xl font-black text-white uppercase leading-tight" translate="no">{item.title}</h4>
                      <p className="text-zinc-400 text-base md:text-lg leading-relaxed max-w-md">{item.desc}</p>
                    </div>
                  </div>
                </Card>
              ))}
